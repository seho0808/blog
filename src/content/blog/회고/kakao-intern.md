...
- <span class="text-orange">2024-04-11 작성: 한 달 동안 생각해보았는데, 일부 멘토 분들에게 나의 행동들이 거만해보였을 것 같다. 기술적으로 궁금한 것이 따로 없다고도 했었고, 지라와 같은 것도 이미 해서 다 안다는 듯이 말했었다. 전반적으로 다 이미 알고 있다는 듯이 과도한 자신감에 차서 생활한 것 같다. 그냥 가만히 있었으면 되었을 것도 이미 해봤다, 이미 안다는 식으로 많이 말한 것 같다. 그리고 코드적으로도 문제가 있었던 것 같다. 4월 초에 dnd를 복잡한 UX로 다시 제대로 구현해보았는데, 정말 어려웠다. 아마 대기업 실무에서는 캐러셀이나 dnd 같은 인터렉션들의 UX를 완벽하게 하기 위해서 엄청난 디버깅을 하셨을 것이고 평상시에도 많은 시간을 쓰신다고 생각한다. 그런데 이런 UX에 집중하지 않고 너무 구조에만 집중해서 "얘는 프론트엔드를 하는 애인데 왜 벡엔드처럼 구조에만 집착하지"라는 생각이 충분히 들었을만 했던 것 같다. 이처럼 나는 아직 모르는게 너무나도 많다. 차분하게 겸손하게 행동하자. 너무 다른 분들의 시선을 의식해서 잘보이려고 하지말고 나 자신의 발전에 집중하자.</span>

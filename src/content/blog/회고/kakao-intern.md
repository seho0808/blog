...
<span class="text-purple"> => 아래 노란 글씨를 기억해내고 하고 난 뒤에 생각하니 위의 문단들은 모두 협업 첫날에 몇 시간 동안 토의할 때 있었던 일이었고, 이후에 내가 의견 조정을 위해 아래와 같이 진행했었다.</span>

<span class="text-yellow">3월 15일 작성: 내가 워낙 잘못한것처럼 된 것 같아서 불합격 이후 며칠 동안 하나하나 회고를 해보았는데, 협업 두 번째 날에 내가 "그러면 각자 생각하는 구조를 간단하게 구현해보고 그걸 종합해보는건 어떤지"에 대해 의견을 냈었는데, 이걸 격하게 반대당했었고, 그래서 배려했었던 것도 기억이 난다. 격하게 반대하셨던 인턴분의 의견은 작업을 A(블록) B(구조+편집영역) C(드래그드랍+버튼)로 나누고 세 명이서 각자 개발하고 싶다였고, 처음에 내키지 않았지만 그것이 편하다고 하셔서 그렇게 진행했었다. 그렇게 해서 나누었던 것인데... 오히려 나중에 평가를 받을 때 보니 내가 독단적으로 무조건적으로 구조가 있었어야한다고 밀고 나간 것처럼 되어있었다. 그리고 나도 첫날에 내가 구조가 있어야한다고 주장했던 것이 기억이 나서 실제로 내가 계속 다 밀고 나간 것처럼 2월 내내 동안 그렇게 기억했는데, 불합격 통지 후 며칠 동안 모든 기억들을 계속 끄집어내고 나서야 협업 초창기 일들이 기억난다. 내가 막무가내로 의견을 밀고나간 것은 아니었다!!!!!! 무조건 기록을 했었어야했다...</span>

...
내가 그만큼 더 능동적으로 감정적 문제를 소통으로 잘 해결했어야한다. 원래의 나라면 잘 해냈을 것인데, 평가를 위한 인턴이라는 자리가 인턴 리더인 파트장님에게 다가가기 어렵게 만든 것 같다.
(+작년까지 1.5년 동안 군대에서 령급 & 장급들이랑 일하다보니 직급 높은 분에게 말하기 어려워하는 점이 심해졌고 +인턴 때 신경써야할 것이 많아 놓친 것도 있다.)

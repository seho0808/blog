...
<span class="text-purple"> => 아래 노란 글씨를 기억해내고 하고 난 뒤에 생각하니 위의 문단들은 모두 협업 첫날에 처음 30분 동안 토의할 때 있었던 일이었고, 직후에 내가 의견 조정을 위해 아래와 같이 진행했었다.</span>

<span class="text-yellow">3월 15일 작성: 내가 워낙 잘못한것처럼 된 것 같아서 불합격 이후 며칠 동안 하나하나 회고를 해보았는데, 협업 첫 번째 날 의견 좁히기가 안될 때 내가 "그러면 각자 생각하는 구조를 간단하게 구현해보고 그걸 종합해보는건 어떤지"에 대해 의견을 냈었는데, 이걸 격하게 반대당했었고, 그래서 배려했었던 것도 기억이 난다. 격하게 반대하셨던 인턴분의 의견은 작업을 A(블록) B(구조+편집영역) C(구조+드래그드랍+버튼)로 나누고 세 명이서 각자 개발하고 싶다였고, 나는 처음에 내키지 않았지만 그것이 편하다고 하셔서 그렇게 진행했었다. 서로 "왜 그렇게 생각하시나요?" 라는 꼬리질문을 안해서 서로 입장을 이해하지 않고 이건 너 말대로, 저건 내 말대로 50% 나누자 이런 식으로 된 것 같다. 내 입장은 "아 다른 인턴 분이 아직 구조에 대해 적응 할 시간이 필요하고 나는 구조가 필요다고 생각하는데.. 그러면 시간을 두고 각자 프로젝트 골격을 만들어보면 좋겠다." 였고, 반대했던 인턴분의 입장은 "아 나는 구조를 잘 모르는데 구조를 짜면 내가 뒤쳐질 수 있겠다."인 것 같다(추측임). 그렇게 해서 나누었던 것인데... 오히려 나중에 평가를 받을 때 보니 내가 독단적으로 무조건적으로 구조가 있었어야한다고 밀고 나간 것처럼 되어있었다. 그리고 나도 첫날에 내가 구조가 있어야한다고 주장했던 것이 기억이 나서 실제로 내가 계속 다 밀고 나간 것처럼 2월 내내 동안 그렇게 기억했는데, 불합격 통지 후 며칠 동안 모든 기억들을 계속 끄집어내고 나서야 협업 초창기 일들이 기억난다. 내가 막무가내로 의견을 밀고나간 것은 아니었다!!!!!! 무조건 기록을 했었어야했다...</span>

추가 기억을 적자면, 위처럼 세 명 파트를 나누기로 한 후, 두 명이서 프로젝트 기본 구조를 만들고 한 분이 블록 만드는 것으로 첫 날, 둘째 날 정도 동안 병렬처리를 했다. 이후 합쳤고, 그렇게 프로젝트 초반이 지나갔다. (1차 과제는 워킹 데이 12일 정도 안에 종료되었다.)
...
팀장님이 최종 면접 마지막에 해주신 피드백이 기억에 남는다: "쭉 쭉 밀고 나가며 많은 것을 성취해내는 점은 좋지만, 다른 사람들과 의견 충돌이 있을 때 다른 분들의 관점을 자세히 살피고 넘어가면 더 좋을 것이다." 나는 기술적으로 A, B, C를 구현해보며 비교해보자는 입장이었다면 팀장님이 제시한 방식은 구현 전에 먼저 어떤 이유에서 그 분이 그런 생각을 하셨는지 차분히 물어보고 공감하는 과정을 거치는 것이었다. 팀장님은 비록 세 번의 회의 밖에 만나지 못했지만, 내가 만나뵌 분 중에 가장 의견 수용을 잘하시는 분이었다. 앞으로 협업에서 수렴하지 않는 갈등이 생기면 OO팀장님이라면 어떻게 대처하셨을까를 한번씩 떠올려 볼 것 같다. => 요 문단은 참고로만 기억하자. 위에서 언급한 바와 같이 내가 협업에서 다른 분들의 의견을 아예 묵살한 적은 없었다. 나 자신이 스스로를 표현했던 문구를 바탕으로 팀장님께서 문장을 만드셨을 수도 있다. 왜냐하면 최종 면접 때는 나도 내가 독단적으로 밀고 나간 부분이 있는 줄 알았다. 불합격 며칠 후 회고 전까지는...
...
- <span class="text-red">협업에서 기록을 제대로 하지 못해서 나의 생각 과정과 협업 과정을 정확히 소명해내지 못했음.</span>

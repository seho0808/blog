...
- 붙으셨던 분은 러닝커브가 엄청 빠른 느낌이었고 나는 러닝커브는 덜 빠르지만 새로운 걸 창조해내는 능력이 강한 느낌이었다. 커머스기술팀에서는 전자가 몇 배는 유리하다 느꼈다.
...
<span class="text-orange">다른 분들이 겪고 있는 상황과 의견을 온전히 공감하고 배려해야했다.</span> 마음을 더 넓게 가지고 수용해야했다. 서로 협업이자 경쟁 상대였기 때문에 치열했다고 생각한다. 평가가 있기에 각자 본인이 편한 그라운드로 끌고 가려고 했던 것이었다. 실제 회사에서도 고과가 반영되는 경쟁이 있다면 거기서 이렇게 인원수로 정하거나 하면 안된다. 회사에 도움이 되는 방향으로 생각해야되기에 관점 존중과 이해가 필수다. 제로섬 게임을 하면 회사 전체에 손해다.

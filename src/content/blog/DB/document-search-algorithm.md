...
- 정확도: 검색 정확도는 벡터 기반 DPR + HNSW가 모든 구간에서 압도적으로 정확함.
- 속도: 수십만개의 데이터에서는 압도적으로 BM25가 빠름. 수백만개의 데이터에서는 HNSW가 빠름.
...
- Fine Tuning + Vector DB로 고도화
  ...
  - [Pinecone 가이드](https://www.pinecone.io/learn/series/faiss/vector-indexes/)들에는 얼마나 극단적으로 빠른지에 대해 설명이 써져있긴하다.
